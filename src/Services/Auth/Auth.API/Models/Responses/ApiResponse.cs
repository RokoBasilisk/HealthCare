...
namespace Auth.API.Models.Responses
{
    public class ApiResponse
    {
        ...
        #region HTTP Status 500 IntervalServerError

        public static ApiResponse IntervalServerError(string errorMessage) =>
            new() { Success = false, StatusCode = StatusCodes.Status500InternalServerError, Errors = CreateApiErrors(errorMessage) };


        public static ApiResponse IntervalServerError(IEnumerable<ApiErrorResponse> errors) =>
